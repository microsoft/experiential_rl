...
# Outcome-only RAFT advantage: clamp negative rewards to zero and broadcast scalar reward.
...
def compute_raft_outcome_advantage(
    ...
    **kwargs,
    ...
    """
    Compute advantage for RAFT, operating only on outcome reward (single scalar per response).
