...
def download_wikipedia_corpus(save_path: str, cache_dir: str | None = None):
...
def download_prebuilt_indices(save_path: str, cache_dir: str | None = None):
...
def setup_search_data(
    ...
    wiki_file = download_wikipedia_corpus(data_dir, cache_dir=cache_dir)

    # Download dense index shards
    prebuilt_dir = download_prebuilt_indices(data_dir, cache_dir=cache_dir)
...
def main():
    ...
    parser.add_argument(
        "--hf_cache_dir",
        default=None,
        help="Hugging Face cache directory (use this to avoid Docker cache)",
    )
